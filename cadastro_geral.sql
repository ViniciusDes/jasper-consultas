...
FROM SRF010 SRF
         JOIN API_SIGAMAT ON RF_FILIAL = APS_COD_FILIAL AND APS_COD_EMPRESA = '010'
         JOIN SRA010 SRA ON RA_FILIAL = RF_FILIAL AND RA_MAT = RF_MAT AND RA_SITFOLH NOT IN ('D') AND
         ...
         JOIN RCH010 RCH ON
        RCH_PERSEL = '1' AND RCH_ROTEIR = 'FER' AND
        (RA_FILIAL = RCH_FILIAL OR LEFT(RA_FILIAL, 2) = RCH_FILIAL OR RCH_FILIAL = '') AND RCH.D_E_L_E_T_ <> '*'
