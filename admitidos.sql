...
FROM SRA$P!{CODIGO_EMPRESA} SRA
    ...
    JOIN SX5$P!{CODIGO_EMPRESA} TIPO_ADMISSAO ON  (RA_FILIAL = X5_FILIAL OR LEFT(RA_FILIAL, 2) = X5_FILIAL OR X5_FILIAL = '') AND X5_TABELA = '38' AND X5_CHAVE = RA_TIPOADM
WHERE SRA.D_E_L_E_T_ =  ''
    AND LEFT(RA_ADMISSA, 6) = '$P!{ANO}$P!{MES}'
