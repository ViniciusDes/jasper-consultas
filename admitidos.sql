...
FROM SRA120 SRA
    ...
    JOIN SX5120 TIPO_ADMISSAO ON  (RA_FILIAL = X5_FILIAL OR LEFT(RA_FILIAL, 2) = X5_FILIAL OR X5_FILIAL = '') AND X5_TABELA = '38' AND X5_CHAVE = RA_TIPOADM
WHERE SRA.D_E_L_E_T_ =  ''
    AND LEFT(RA_ADMISSA, 6) = '202005'
    AND RA_FILIAL = '0201'
ORDER BY RA_FILIAL,
         RA_NOME
